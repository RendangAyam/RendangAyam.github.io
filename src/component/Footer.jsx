        ...
        <footer class="bg-gray-700">
            <div id="02" class="max-w-7xl mx-auto py-12 px-4 pt-4 overflow-hidden sm:px-6 lg:px-8">
                <div class="mt-8 flex justify-center space-x-6">
                    <a href="https://www.linkedin.com/in/andrew-christian-widjojo-3a0a57218" class="text-green-400 hover:text-green-600 transition duration-300">
                ...
                Made by 
                <a href="https://www.linkedin.com/in/andrew-christian-widjojo-3a0a57218" className="ml-1 hover:text-green-600 transition duration-300"> Andrew Christian Widjojo</a>
                </p>
            </div>
        </footer>
    )
